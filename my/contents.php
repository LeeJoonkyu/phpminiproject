...
/*
      ...
      if (mysqli_connect_error()){
        ...
        $sql = "SELECT * FROM board WHERE uid = '{$_SESSION['uid']}'";
      ...
      <div id="pagination">
        <div class="btn-group btn-pagination">
          <?php if($s_page-1 ==0){
            $substring='';
            ?>
            <a class="btn btn-default" href="/my/contents.php?page=1">처음</a>
          <a class="btn btn-default" href="//my/contents.php?page=1<?php echo $substring ?>">이전</a>
        <?php } else {  ?>
          <a class="btn btn-default" href="/my/contents.php?page=1">처음</a>
          <a class="btn btn-default" href="/my/contents.php?page=<?php echo $s_page-1 ?>">이전</a>
          <?php } ?>
        ...
        <?php } ?>
        <a class="btn btn-default" href="/my/contents.php?page=<?php echo $e_page+1 ?>">다음
        </a>
        <?php if($s_page-1 ==0){
          $substring='';
          ?>
